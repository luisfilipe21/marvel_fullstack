...
export const Header = () => {
    ...
    const title = clsx(`
        font-marvel text-7xl text-slate-100 font-extrabold tracking-tighter
    `)
    ...
    return (
        ...
        <header className=" flex flex-col justify-center items-center p-8">
            <h1 className= {`${title} bg-red-600`} >MARVEL</h1>
            <div className="flex flex-col justify-center items-center text-white mt-8">
                <p className="pb-4 text-xl">Qual herós você está procurando?</p>
